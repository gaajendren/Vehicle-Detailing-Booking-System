...
<link rel="stylesheet" href="https://code.jquery.com/ui/1.13.3/themes/base/jquery-ui.css">
  ...
  <br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Service Details</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="">Home</a></h6>
            <h6 class="text-body m-0 px-3">/</h6>
            <h6 class="text-uppercase text-body m-0">Service Details</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    ...
    <div class="container-fluid pb-5">
        <div class="container">
        {!! Form::open(array('url' => 'storebooking', 'method' => 'POST', 'files' => true)) !!}
            <div class="row">
                <div class="col-lg-8">
                <h2 class="mb-4">Service Detail</h2>
                    ...
                    <div class="mb-5">
                        ...
                        <label class="form-group">Remarks</label>
                            <textarea class="form-control py-3 px-4" rows="3" name="remarks" id="remarks" placeholder="Remarks..." required="required"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="bg-secondary p-5 mb-5">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="fpx" checked>
