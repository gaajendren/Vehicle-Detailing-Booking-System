                        ...
                        <div class="card card-gutter-lg rounded-4 card-auth">
                            <div class="card-body">
                                <div class="nk-block-head">
                                    ...
                                    <div class="row gy-3">
                                    <form action="postregisterusrwi" method="POST" autocomplete="off" aria-autocomplete="off">
                                            @csrf
                                    <hr>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" name="mykad" id="mykad" placeholder="Enter IC" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <textarea class="form-control" name="address" id="address" placeholder="Enter Address" maxlength="500" required></textarea>
                                                </div>
                                            </div>
                                        </div>
