                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="editEvent">View Event</button>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row g-gs">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" id="eventTitle" placeholder="Event Title" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-7">
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control fc-event-datepicker" id="eventStartDate" placeholder="yyyy-mm-dd" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control fc-event-timepicker" id="eventStartTime" placeholder="hh-mm" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row g-2">
                                                <div class="col-7">
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control fc-event-datepicker" id="eventEndDate" placeholder="yyyy-mm-dd" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-5">
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="form-control fc-event-timepicker" id="eventEndTime" placeholder="hh-mm" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group fc-category-select">
                                            ...
                                            <div class="form-control-wrap">
                                                <select id="eventCategory" class="form-control" disabled></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        elm.forEach(item => {
            ...
            if(calendarEl != 'undefined' && calendarEl != null){
                ...
                const choicesCat = new Choices(eventCategorySelect, {
                    ...
                    shouldSort: false,
                    choices: [
                        { value: 'event-primary', label: 'Wedding Planning Sessions' },
                        { value: 'event-success', label: 'Bridal Showers' },
                        { value: 'event-info', label: 'Vendor Meetings' },
                        { value: 'event-warning', label: 'Dress Fittings' },
                        { value: 'event-danger', label: 'Wedding Rehearsals' },
                        { value: 'event-dark', label: 'Private Consultations' },
                        { value: 'event-primary-soft', label: 'Charity Bridal Events' },
                        { value: 'event-success-soft', label: 'Community Bridal Outreach' },
                        { value: 'event-info-soft', label: 'Bridal Workshops' },
                        { value: 'event-warning-soft', label: 'Fundraising for Weddings' },
                        { value: 'event-danger-soft', label: 'Sponsored Bridal Activities' },
                        { value: 'event-dark-soft', label: 'Bridal Sports Events' }
                    ],
        ...
        error: function (error) {
            ...
            console.error(error);
                ...
                editEvent.addEventListener('click', function(e){
                    ...
                    formTitle.innerText = 'View Event';
...
formEventUpdate.addEventListener('click', function(e){
    ...
    const csrfToken = $('meta[name="csrf-token"]').attr('content');
    const selectedEventId = selectedEvent._def.publicId;

    // Prepare data for the AJAX request
    const eventData = {
        title: formInputTitle.value,
        start: formInputStartDate.value,
        end: formInputEndDate.value,
        starttime: formInputStartTime.value,
        endtime: formInputEndTime.value,
    ...
    $.ajax({
        url: `/update-event/${selectedEventId}`,
        type: 'PUT',
        data: eventData,
        headers: {
            'X-CSRF-TOKEN': csrfToken,
...
NioApp.Calendar.init = function () {
        ...
        function mapEvent(event) {
            return {
                ...
                start: event.eventStartDate + 'T' + event.eventStartTime + 'Z',
                end: event.eventEndDate + 'T' + event.eventEndTime + 'Z',
                className: 'fc-' + event.eventCategory,
